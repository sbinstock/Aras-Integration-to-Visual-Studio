...
namespace ArasMenu
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class DeploymentUnlockMethodCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeploymentUnlockMethodCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        private DeploymentUnlockMethodCommand(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static DeploymentUnlockMethodCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new DeploymentUnlockMethodCommand(package);
        }
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            util.setStatusBar(string.Format("Success: {0} was succesfully unlocked on the deployment server with method ", methodName));
        }
    }
}
