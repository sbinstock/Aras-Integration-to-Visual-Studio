...
namespace ArasMenu
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class DeploymentManageLockCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeploymentManageLockCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        private DeploymentManageLockCommand(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static DeploymentManageLockCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new DeploymentManageLockCommand(package);
        }
