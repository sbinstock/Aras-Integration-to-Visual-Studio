...
namespace ArasMenu
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class LockMethodCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LockMethodCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        private LockMethodCommand(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static LockMethodCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new LockMethodCommand(package);
        }
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            Item iQry = inn.newItem("Method", "lock");
