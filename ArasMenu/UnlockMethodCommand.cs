...
namespace ArasMenu {
	...
	/// Command handler
	/// </summary>
	internal sealed class UnlockMethodCommand {
		/// <summary>
		/// Command ID.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="UnlockMethodCommand"/> class.
		/// Adds our command handlers for menu (commands must exist in the command table file)
		/// </summary>
		/// <param name="package">Owner package, not null.</param>
		private UnlockMethodCommand(Package package) {
			if(package == null) {
		...
		/// </summary>
		public static UnlockMethodCommand Instance {
			get;
			private set;
		}
		...
		public static void Initialize(Package package) {
			Instance = new UnlockMethodCommand(package);
		}
		...
		private void MenuItemCallback(object sender, EventArgs e) {
			...
			util.setStatusBar(string.Format("Success: {0} was succesfully unlocked on the server with method ", methodName));
		}
	}
}
