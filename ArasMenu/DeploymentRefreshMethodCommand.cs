...
namespace ArasMenu
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class DeploymentRefreshMethodCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeploymentRefreshMethodCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        private DeploymentRefreshMethodCommand(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static DeploymentRefreshMethodCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new DeploymentRefreshMethodCommand(package);
        }
