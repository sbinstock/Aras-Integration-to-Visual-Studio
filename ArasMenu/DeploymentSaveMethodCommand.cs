...
namespace ArasMenu
{
    ...
    internal sealed class DeploymentSaveMethodCommand
    {
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            //find the World identity and set the method's execution_allowed_to later
            ...
            if (iQry.isError() || iQry.isEmpty())
            {
                ...
                if (response == 6)
                {
                    ...
                    //add property that automatically makes the method default to "execution_allowed_to" the World identity
