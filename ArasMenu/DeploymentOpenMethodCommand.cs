...
namespace ArasMenu
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class DeploymentOpenMethodCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeploymentOpenMethodCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        private DeploymentOpenMethodCommand(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static DeploymentOpenMethodCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new DeploymentOpenMethodCommand(package);
        }
